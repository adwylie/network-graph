...
public class Sensor extends Node implements DrawableInterface {
    ...
    // Drawing things.
    private Color antennaColor = new Color(
        Color.BLUE.getRed(), Color.BLUE.getGreen(), Color.BLUE.getBlue(), 55);
    ...
    public void drawMe(Graphics g) {
        ...
        float newAntennaDirection =
                this.antennaDirection + (180f - this.antennaDirection) * 2;
        
        g.fillArc(
                (int) (this.x - this.antennaRange),
                (int) (this.y - this.antennaRange),
                (int) (this.antennaRange * 2),
                (int) (this.antennaRange * 2),
                // Start angle.
